...
curl -s 'http://127.0.0.1:19200/sds-cncf-devstats-github-issue-raw/_search' | jq '.hits.hits[]._source' | tee github-raw.json
curl -s 'http://127.0.0.1:19200/sds-cncf-devstats-github-issue/_search' | jq '.hits.hits[]._source' | tee github-rich.json
