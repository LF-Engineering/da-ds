...
func (j *DSGerrit) GetGerritReviews(ctx *Ctx, after string, afterEpoch float64, startFrom int) (reviews []map[string]interface{}, newStartFrom int, err error) {
	...
	sout, serr, err = ExecCommand(ctx, cmdLine, "", nil)
	// sout, serr, err = `{"project":"sdnc/oam","branch":"istanbul","id":"I25d3eea12c4c4f86322520cf344b177eceea81f6","number":124840,"subject":"Roll istanbul oam to next snapshot","owner":{"name":"Herbert Eiselt","email":"herbert.eiselt@highstreet-technologies.com","username":"highstreetherbert"},"url":"https://gerrit.onap.org/r/c/sdnc/oam/+/124840","commitMessage":"Roll istanbul oam to next snapshot\n\nIssue-ID: SDNC-1625\nSigned-off-by: highstreetherbert \u003cherbert.eiselt@highstreet-technologies.com\u003e\nChange-Id: I25d3eea12c4c4f86322520cf344b177eceea81f6\n","createdOn":1634042959,"lastUpdated":1634117496,"open":false,"status":"ABANDONED","comments":[{"timestamp":1634042959,"reviewer":{"name":"Herbert Eiselt","email":"herbert.eiselt@highstreet-technologies.com","username":"highstreetherbert"},"message":"Uploaded patch set 1."},{"timestamp":1634043098,"reviewer":{"name":"ONAP Jobbuilder","email":"onap-jobbuilder@jenkins.onap.org","username":"onap-jobbuilder"},"message":"Patch Set 1:\n\nBuild Started https://jenkins.onap.org/job/sdnc-oam-maven-verify-istanbul-mvn36-openjdk11/2/ (1/2)"},{"timestamp":1634043142,"reviewer":{"name":"ONAP Jobbuilder","email":"onap-jobbuilder@jenkins.onap.org","username":"onap-jobbuilder"},"message":"Patch Set 1:\n\nBuild Started https://jenkins.onap.org/job/sdnc-oam-review-verification-maven-istanbul/2/ (2/2)"},{"timestamp":1634044302,"reviewer":{"name":"Dan Timoney","email":"dtimoney@att.com","username":"djtimoney"},"message":"Patch Set 1: Code-Review-2\n\nAt this point, we should not be including any SNAPSHOT versions in our dockers.  If there are changes in any repos, we need to do release builds and then bump sdnc/oam to the updated released version."},{"timestamp":1634044856,"reviewer":{"name":"ONAP Jobbuilder","email":"onap-jobbuilder@jenkins.onap.org","username":"onap-jobbuilder"},"message":"Patch Set 1: Verified+1\n\nBuild Successful \n\nhttps://jenkins.onap.org/job/sdnc-oam-maven-verify-istanbul-mvn36-openjdk11/2/ : SUCCESS\n\nLogs: https://logs.onap.org/production/vex-yul-ecomp-jenkins-1/sdnc-oam-maven-verify-istanbul-mvn36-openjdk11/2\n\nhttps://jenkins.onap.org/job/sdnc-oam-review-verification-maven-istanbul/2/ : SUCCESS\n\nLogs: https://logs.onap.org/production/vex-yul-ecomp-jenkins-1/sdnc-oam-review-verification-maven-istanbul/2"},{"timestamp":1634117496,"reviewer":{"name":"Herbert Eiselt","email":"herbert.eiselt@highstreet-technologies.com","username":"highstreetherbert"},"message":"Abandoned"}],"patchSets":[{"number":1,"revision":"169bd0b81d165dce2ee9518bd49d2a2da218d63c","parents":["0fab18d499c857b08812b099d9e0d88a93102247"],"ref":"refs/changes/40/124840/1","uploader":{"name":"Herbert Eiselt","email":"herbert.eiselt@highstreet-technologies.com","username":"highstreetherbert"},"createdOn":1634042959,"author":{"name":"Herbert Eiselt","email":"herbert.eiselt@highstreet-technologies.com","username":"highstreetherbert"},"kind":"REWORK","approvals":[{"type":"Code-Review","description":"Code-Review","value":"-2","grantedOn":1634044302,"by":{"name":"Dan Timoney","email":"dtimoney@att.com","username":"djtimoney"}},{"type":"Verified","description":"Verified","value":"1","grantedOn":1634044856,"by":{"name":"ONAP Jobbuilder","email":"onap-jobbuilder@jenkins.onap.org","username":"onap-jobbuilder"}}],"sizeInsertions":6,"sizeDeletions":6}],"allReviewers":[{"name":"ONAP Jobbuilder","email":"onap-jobbuilder@jenkins.onap.org","username":"onap-jobbuilder"},{"name":"Dan Timoney","email":"dtimoney@att.com","username":"djtimoney"},{"name":"David Stilwell","email":"stilwelld@att.com","username":"stilwelld"},{"name":"Michael D�rre","email":"michael.duerre@highstreet-technologies.com","username":"metaljackL"}]}`, "", nil
	if err != nil {
		Printf("error executing %v: %v\n%s\n%s\n", cmdLine, err, sout, serr)
		return
	}
