...
func (j *DSGerrit) GetGerritReviews(ctx *Ctx, after string, afterEpoch float64, startFrom int) (reviews []map[string]interface{}, newStartFrom int, err error) {
	...
	sout, serr, err = ExecCommand(ctx, cmdLine, "", nil)
	// sout, serr, err = `{"project":"sdc/sdc-be-common","branch":"master","id":"Ieacedaa9c5204c2eab6ee96870f9b7726e06fc43","number":121462,"subject":"Fix tests not running after junit5 upgrade","owner":{"name":"Andr� Schmid","email":"andre.schmid@est.tech","username":"andre.schmid"},"url":"https://gerrit.onap.org/r/c/sdc/sdc-be-common/+/121462","commitMessage":"Fix tests not running after junit5 upgrade\n\nThere was a conflict with the junit version in spring boot and\nthe one in the project. With that, maven surefire plugin was not\nfinding the tests.\nThe org.onap.sdc.security.logging.wrappers.LoggerTest was also broken\nwith a conflict with mockito and an undesirable powermock library from\norg.onap.portal.sdk:epsdk-fw artifact. There was also an incorrect\nassertion in the test.\n\nIssue-ID: SDC-3604\nSigned-off-by: André Schmid \u003candre.schmid@est.tech\u003e\nChange-Id: Ieacedaa9c5204c2eab6ee96870f9b7726e06fc43\n","createdOn":1621524278,"lastUpdated":1621527597,"open":false,"status":"MERGED","comments":[{"timestamp":1621524278,"reviewer":{"name":"Andr� Schmid","email":"andre.schmid@est.tech","username":"andre.schmid"},"message":"Uploaded patch set 1."},{"timestamp":1621524535,"reviewer":{"name":"ONAP Jobbuilder","email":"onap-jobbuilder@jenkins.onap.org","username":"onap-jobbuilder"},"message":"Patch Set 1:\n\nBuild Started https://jenkins.onap.org/job/sdc-sdc-be-common-master-verify-java/120/"},{"timestamp":1621524687,"reviewer":{"name":"ONAP Jobbuilder","email":"onap-jobbuilder@jenkins.onap.org","username":"onap-jobbuilder"},"message":"Patch Set 1: Verified+1\n\nBuild Successful \n\nhttps://jenkins.onap.org/job/sdc-sdc-be-common-master-verify-java/120/ : SUCCESS\n\nLogs: https://logs.onap.org/production/vex-yul-ecomp-jenkins-1/sdc-sdc-be-common-master-verify-java/120"},{"timestamp":1621526917,"reviewer":{"name":"Vasyl Razinkov","email":"vasyl.razinkov@est.tech","username":"vasraz"},"message":"Patch Set 1: Code-Review+2"},{"timestamp":1621526921,"reviewer":{"name":"Vasyl Razinkov","email":"vasyl.razinkov@est.tech","username":"vasraz"},"message":"Change has been successfully merged by Vasyl Razinkov"},{"timestamp":1621526932,"reviewer":{"name":"Vasyl Razinkov","email":"vasyl.razinkov@est.tech","username":"vasraz"},"message":"Patch Set 1:\n\nrun-sonar"},{"timestamp":1621527435,"reviewer":{"name":"ONAP Jobbuilder","email":"onap-jobbuilder@jenkins.onap.org","username":"onap-jobbuilder"},"message":"Patch Set 1:\n\nBuild Successful \n\nhttps://jenkins.onap.org/job/sdc-sdc-be-common-master-merge-java/59/ : SUCCESS\n\nLogs: https://logs.onap.org/production/vex-yul-ecomp-jenkins-1/sdc-sdc-be-common-master-merge-java/59"},{"timestamp":1621527597,"reviewer":{"name":"ONAP Jobbuilder","email":"onap-jobbuilder@jenkins.onap.org","username":"onap-jobbuilder"},"message":"Patch Set 1:\n\nBuild Successful \n\nhttps://jenkins.onap.org/job/sdc-sdc-be-common-sonar/724/ : SUCCESS (skipped)\n\nLogs: https://logs.onap.org/production/vex-yul-ecomp-jenkins-1/sdc-sdc-be-common-sonar/724"}],"patchSets":[{"number":1,"revision":"7f2e3520839a322f2c659bbf2501720a84bf0635","parents":["d9390c23f8568c4df7797eb321161cef725221b0"],"ref":"refs/changes/62/121462/1","uploader":{"name":"Andr� Schmid","email":"andre.schmid@est.tech","username":"andre.schmid"},"createdOn":1621524278,"author":{"name":"Andr� Schmid","email":"andre.schmid@est.tech","username":"andre.schmid"},"kind":"REWORK","approvals":[{"type":"Verified","description":"Verified","value":"1","grantedOn":1621524687,"by":{"name":"ONAP Jobbuilder","email":"onap-jobbuilder@jenkins.onap.org","username":"onap-jobbuilder"}},{"type":"Code-Review","description":"Code-Review","value":"2","grantedOn":1621526917,"by":{"name":"Vasyl Razinkov","email":"vasyl.razinkov@est.tech","username":"vasraz"}},{"type":"SUBM","value":"1","grantedOn":1621526921,"by":{"name":"Vasyl Razinkov","email":"vasyl.razinkov@est.tech","username":"vasraz"}}],"sizeInsertions":45,"sizeDeletions":22}],"allReviewers":[{"name":"Vasyl Razinkov","email":"vasyl.razinkov@est.tech","username":"vasraz"},{"name":"ONAP Jobbuilder","email":"onap-jobbuilder@jenkins.onap.org","username":"onap-jobbuilder"},{"name":"Anderson Ribeiro","email":"anderson.ribeiro@est.tech","username":"aribeiro"},{"name":"Julien Bertozzi","email":"julien.bertozzi@intl.att.com","username":"JulienBe"},{"name":"Ojas Dubey","email":"Ojas.Dubey@amdocs.com","username":"ojasdubey"},{"name":"Xue Gao","email":"xue.gao@intl.att.com","username":"xuegao"},{"name":"tali orenbach","email":"tali.orenbach@amdocs.com","username":"talio"},{"name":"Christophe Closset","email":"christophe.closset@intl.att.com","username":"ChrisC"},{"name":"Ilana Paktor","email":"ilanap@amdocs.com","username":"ilanap"},{"name":"Michael Morris","email":"michael.morris@est.tech","username":"MichaelMorris"},{"name":"S�bastien Determe","email":"sebastien.determe@intl.att.com","username":"sebdet"}]}`, "", nil
	if err != nil {
		Printf("error executing %v: %v\n%s\n%s\n", cmdLine, err, sout, serr)
		return
	}
...
func (j *DSGerrit) EnrichItem(ctx *Ctx, item map[string]interface{}, author string, affs bool, extra interface{}) (rich map[string]interface{}, err error) {
	if ctx.Debug > 2 {
		Printf("EnrichItem call: %+v\n", item)
		defer func() {
			Printf("EnrichItem returns: %+v, %+v\n", err, rich)
		}()
	}
	...
	if affs {
		...
		if err != nil {
			Printf("AffsItems error: %+v for review %+v\n", err, review)
			return
		}
